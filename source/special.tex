...
or when the expression in a return statement is a (possibly parenthesized) 
\nonterminal{id-expression}, that names an object with
automatic storage duration declared in the body or
\nonterminal{parameter-declaration-clause},
of the innermost enclosing function or \nonterminal{lambda-expression},
